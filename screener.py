...
"""
stockListBeat = ['AARTIIND','CANFINHOME', 'CAPLIPOINT', 'CEATLTD', 'EMMBI', 'FAGBEARING', 'HATSUN', 'HMVL', \
                'KEI', 'KAJARIACER', 'KITEX', 'KOVAI', 'MANALIPETC', 'NDL', 'NITINSPIN', 'PIIND', 'PAGEIND', \
                'PANCHSHEEL', 'SKMEGGPROD', 'SANGAMIND', 'SRIPIPES', 'TVSMOTOR', 'TVSSRICHAK', 'TATAELXSI', 'VOLTAS']
"""
#All the 73stocks filters by program
"""
stockListBeat = ['AIAENG', 'AARTIIND', 'AJMERA', 'APOLLOTYRE', 'ASAHISONG', 'ASIANPAINT', 'BAJAJCORP', 'BAJFINANCE',\
                 'BAJAJFINSV', 'BALAMINES', 'CADILAHC', 'CANFINHOME', 'CAPLIPOINT', 'CARBORUNIV', 'CEATLTD', 'CENTURYPLY',\
                 'CERA', 'CHOLAFIN', 'DSKULKARNI', 'DABUR', 'DENORA', 'EICHERMOT', 'EMMBI', 'FAGBEARING', 'GABRIEL', 'GALLANTT',\
                 'GARWALLROP', 'HDFCBANK', 'HATSUN', 'HERITGFOOD', 'HITECHGEAR', 'HIMATSEIDE', 'HMVL', 'HONDAPOWER', 'IVP', \
                 'INDUSINDBK', 'KPRMILL', 'KEI','KAJARIACER', 'KSL', 'KITEX', 'KOVAI', 'MRF', 'MANALIPETC', 'MARUTI','MIRZAINT',\
